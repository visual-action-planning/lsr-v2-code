...
data_train_opt['dataset_name'] = 'action_box_stacking_normal_task_MM'
...
data_test_opt['dataset_name'] = 'action_box_stacking_normal_task_MM'
...
data_original_opt['path_to_original_train_data'] = './datasets/action_data/train_action_box_stacking_normal_task_2500'
data_original_opt['path_to_original_test_data'] = './datasets/action_data/test_action_box_stacking_normal_task_2500'
